...
<div class="body1" id="home">
  <img src="images/123.jpg" width="100%">
    <div class="para">
      <h2>Drink Fresh <br> Get Fresh</h2>
      <p>Lorem ipsua ipsa vel quia exercitatquid <br> brmagnam repudiandae iure eius!</p>
      <a class="waves-effect waves-light btn-large #ffe57f amber accent-1 " href="index.php">Contact Us</a>
  </div>
